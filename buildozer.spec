...
source.include_exts = py,png,jpg,kv,atlas,ttf,TTF,gif
...
requirements = python3,kivy==master,pygments,androidstorage4kivy,https://github.com/kivymd/KivyMD/archive/master.zip,sqlite3,kvdroid
...
presplash.filename = %(source.dir)s/assets/img/kiwi.png

# (str) Icon of the application
icon.filename = %(source.dir)s/assets/img/kiwi.png
